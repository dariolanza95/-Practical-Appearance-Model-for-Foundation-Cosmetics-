...
class MyCoatedDiffuseBxDF;
class CoatedDiffuseBxDFMixedParticles;
class TransmittanceBxDFMixedParticles;
class TransmittanceBxDFMixedParticlesAdvanced;

class TransmittanceBxDFNormFresnel;
class TransmittanceBxDFNormFresnelAdvanced;
...
// BxDF Definition
class BxDF
    : public TaggedPointer<DiffuseTransmissionBxDF, DiffuseBxDF, CoatedDiffuseBxDF,MyCoatedDiffuseBxDF,CoatedDiffuseBxDFMixedParticles,TransmittanceBxDFMixedParticles,
    TransmittanceBxDFNormFresnel,TransmittanceBxDFNormFresnelAdvanced,TransmittanceBxDFMixedParticlesAdvanced,CoatedConductorBxDF, DielectricBxDF, ThinDielectricBxDF,
                           HairBxDF, MeasuredBxDF,MyMeasuredBxDF, ConductorBxDF, NormalizedFresnelBxDF, SheenVolumeBxDF> {
  public:
    // BxDF Interface

...
class CoatedDiffuseMaterialMixedParticles {
  public:
    ...
    CoatedDiffuseMaterialMixedParticles(SpectrumTexture reflectance, FloatTexture uRoughness,
                          ...
                          FloatTexture displacement, Image *normalMap,
                          bool remapRoughness, int maxDepth, int nSamples, FloatTexture cosmetic_map)
        : displacement(displacement),
          normalMap(normalMap),
          reflectance(reflectance),
          uRoughness(uRoughness),
  ...
  private:
    ...
    FloatTexture cosmetic_map;//White parts indicate the cosmetic regions
};
